%macro x86_EnterRealMode 0
    [bits 32]
    jmp word 18h: .pmode16      ;1 - jmp to 16-bit protected mode
...
%macro LinearToSegOffset 4
    ...
    mov %2, %4   ; move lower bits of %3 into segment register
    mov %3, %1   ; reload linear address again into %3
    and %3, 0xF  ; mask to get offset within segment
